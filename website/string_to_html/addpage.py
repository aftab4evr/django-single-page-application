            ...
            <div class="setting-page">
               <form class="commonForm" >
                  <div class="row">
                     ...
                     <div class="col-md-12">
                        <div class="form-group row">
                           ...
                           <div class="col-md-8 col-8 d-flex align-items-center">
                              <input type="text" id="id_email" name="email" maxlength="50" class="form-control"
                                  required>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-12">
                        <div class="form-group row">
                           ...
                           <div class="col-md-8 col-8 d-flex align-items-center">
                              <input type="number" id="id_mobile" style="margin-left: 5px;" name="mobile" maxlength="50"
                                 class="form-control" value="{{myuser_form.mobile.value}}" required>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="text-center mt20">
                     ...
                     <button type="button" onclick="handelAddRecord()" class="btn max-WT-180 btnGreen mr5 pTB8">Add
                        Record</button>
                  </div>
            </div>
         </div>
